 ...
 *
 * About section displaying candidate bio and vision.
 * Follows diijondacosta.com About pattern with clean typography.
 *
 * Features:
 * - Section ID for Navigation scroll spy
 * - Three subsections: Who I Am, Why I'm Running, My Vision
